    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.CharField(default=0, max_length=1)),
            ],
            options={
                'verbose_name': '用户信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Department_name', models.CharField(max_length=20, verbose_name='部门')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32)),
                ('department_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Dep')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='U2R',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.PermissionList'),
        ),
        migrations.AddField(
            model_name='permission',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.User2Role'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='department',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Dep'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
